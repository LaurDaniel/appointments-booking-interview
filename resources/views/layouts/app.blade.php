                    ...
                    <ul class="navbar-nav me-auto">
                        @auth
                            @if (auth()->user()->hasRole('Admin'))
                                <li class="nav-item ">
                                    <a class="nav-link {{ Route::is('home') ? 'active' : '' }}" href="{{ route('home') }}">{{ __('Admin Dashboard') }}</a>
                                </li>
                            @else
                                <li class="nav-item ">
                            ...
                            @endif
                            <li class="nav-item ">
                                    <a class="nav-link {{ Route::is('booking') ? 'active' : '' }}" href="{{ route('booking') }}">{{ __('Book Appointment') }}</a>
                            </li>
